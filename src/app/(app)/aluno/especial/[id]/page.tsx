...
export default function AtividadeEspecialAlunoPage() {
  ...
  return <div className="view special-detail-view">
    ...
    {activity.external_url && <section className="card special-detail-section special-launch-card"><div><div className="eyebrow">Atividade</div><h3>Pronto para começar?</h3><p className="muted">A atividade será aberta em uma nova aba. Esta página continuará disponível para você consultar as instruções.</p></div><a className="btn gold" href={activity.external_url} target="_blank" rel="noopener noreferrer">Abrir atividade ↗</a></section>}
