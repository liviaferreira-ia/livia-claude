...
const features = [
  ...
  {
    tint: "tint-gold",
    title: "Prática guiada de conversa",
    desc: "Treine respostas em inglês com perguntas prontas e apoio de vocabulário.",
    icon: (
  ...
  },
  {
    tint: "tint-warn",
    title: "Pronúncia",
    desc: "Ouça uma frase, grave sua resposta e compare com o modelo de referência.",
    icon: (
