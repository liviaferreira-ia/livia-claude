...
const b1Unit = (
  ...
  lessons: [
    ...
    { title: "Precisão e vocabulário em contexto", meta: "Praticar · 12 min", status: n === 1 ? "now" : "locked", phase: "practice", href: n === 1 ? "/aluno/praticar" : undefined },
    { title: `Conversa guiada · ${title}`, meta: "Falar · 9 min", status: n === 1 ? "now" : "locked", phase: "speak", href: n === 1 ? "/aluno/pronuncia" : undefined },
    { title: mission, meta: "Missão com IA · 12 min", status: n === 1 ? "now" : "locked", phase: "mission", href: n === 1 ? "/aluno/roleplay" : undefined },
    { title: checkpoint ?? `Domínio · ${title}`, meta: "Domínio · 10 min", status: "locked", phase: "mastery" },
  ],
});
